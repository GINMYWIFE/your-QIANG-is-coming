...
export const historyApi = {
   ...
   * 获取个性化成长建议
   */
  async getPersonalizedSuggestions(resumeId: number): Promise<PersonalizedSuggestion> {
    return request.get<PersonalizedSuggestion>(`/api/history/resumes/${resumeId}/suggestions`);
  },
