...
public class InterviewPersistenceService {
    ...
    public InterviewSessionEntity saveSession(String sessionId, Long resumeId, 
        ...
        try {
            ...
            log.info("面试会话已保存: sessionId={}, resumeId={}, knowledgeBaseId={}", sessionId, resumeId, knowledgeBaseId);
    ...
    /**
     * 获取简历的最近 5 次指定状态的面试记录
     */
    public List<InterviewSessionEntity> findTop5ByResumeIdAndStatusOrderByCreatedAtDesc(Long resumeId, InterviewSessionEntity.SessionStatus status) {
        return sessionRepository.findTop5ByResumeIdAndStatusOrderByCreatedAtDesc(resumeId, status);
    }
